...
def _deduplicate_exact(events: list[ConcertEvent]) -> list[ConcertEvent]:
    ...
    # Accent folding is a fallback only.  If two distinct exact spellings are
    # present for the same date/venue, keep them separate unless an explicit
    # alias has already made their exact identities equal.
