...
## 2026-09-12 — Structured album-review title identity narrowing

Current-generation testing exposed a systemic article-subject problem.

Example:
Album Review: Monty Alexander - A Jamarican In Paris

Before fix:
- primaryArtists: ["Monty Alexander","Paris"]
- Apple artist ID: null
- identityLevel: HIGH
- LISTEN: 43
- WATCH: 47
- unrelated Charli xcx WATCH recommendations were regenerated by the current code

Control:
Monty Alexander @ Birdland, NYC - August 12th, 2026
- primaryArtists: ["Monty Alexander"]
- Apple artist ID: 2987018
- LISTEN: 43
- WATCH: 0

Cause:
eeTitleArtistCandidate_() already parsed structured album-review titles correctly, but authoritative title-subject narrowing was applied only to concert_review articles.

Fix:
- existing authoritative title rule now applies to both concert_review and album_review
- exact structured title subject is allowed to narrow primary artist matches
- no artist/location-specific hardcoding added

Expected production result for the Monty album review:
- primaryArtists: ["Monty Alexander"]
- Apple artist ID: 2987018
